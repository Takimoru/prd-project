...
import { CREATE_PROGRAM_MUTATION } from "../../../../graphql/dashboard";
import { X } from "lucide-react";
import toast from "react-hot-toast";

interface CreateProgramModalProps {
  onClose: () => void;
  // userId not used, managed by server context
}
    ...
    try {
      await createProgram({
        variables: {
          ...
          // createdBy is handled by server context
        },
        refetchQueries: ['GetDashboardData'] // Refresh dashboard
      });
