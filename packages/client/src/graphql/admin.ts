...
export const GENERATE_TEAMS = gql`
  mutation GenerateTeams($input: GenerateTeamsInput!) {
    generateTeams(input: $input)
  }
`;

export const FINALIZE_TEAMS = gql`
  mutation FinalizeTeams($input: FinalizeTeamsInput!) {
    finalizeTeams(input: $input) {
      id
      name
      programId
      leaderId
